    ...
    def __init__(self, psl_alignment, sorted_exons_attr, strand_specific, sqlite3_db_genes):
        ...
        if sqlite3_db_genes != None:
            ...
            for internal_isoform in self.internal_isoforms:
                ...
                self.children_exons_dict[internal_isoform.id] = list(sqlite3_db_genes.children(internal_isoform.id, featuretype=UtilsAnnotations.type_exons, order_by='start'))
                # for prokaryotes:
                ...
                for exon in self.children_exons_dict[internal_isoform.id]:
                    self.ids_children_exons_dict[internal_isoform.id].add(exon.id)